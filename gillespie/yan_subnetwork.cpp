...
void yan_network_init(BasicGillespie &BG) {
  ...
  // Protein
  double DEF_PRT_DEG = 1.0/(5.0*3600); // ~5hr mean lifetime default protein degradation
...
int main(int argc,char const ** argv) {
  ...
  State IC{{"mY",2},{"Y",50},{"YP",0},{"P2",500},{"P2P",0},{"M",0},{"S",0},{"Y_Y",0},{"M_P2P",0},{"M_Y",0},{"M_YP",0}};
  ...
  std::string results_file("results/yan_subnetwork.txt");
